    ...
    <div className="flex flex-col items-center justify-center h-screen font-serif">
      ...
      <div className="flex space-x-4">
        <Link href="/employee/form">
          <button className="px-4 py-2 bg-blue-500 hover:bg-blue-900 text-white rounded">Add Employee</button>
        </Link>
        <Link href="/employee/list">
          <button className="px-4 py-2 bg-green-500 hover:bg-green-900 text-white rounded">View Employees</button>
        </Link>
      </div>
    </div>
  );
